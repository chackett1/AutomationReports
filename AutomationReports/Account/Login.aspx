...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="col-md-4" id="loginBox" style="border:solid; border-radius: 3px; border-color: #9c27b0; background-color:white;">
        <section id="loginForm">
            <div style="padding: 40px;">
                
            <div class="form-horizontal">
            <h3 style="padding:0px">easyuser1 easypass1</h3>
